...
interface Props {
  ...
  account: {
    ...
    roleId: number | null
    effective: string[]
    // L'**état** du second facteur (CC-114), jamais le secret ni un code : un administrateur
    // a besoin de savoir si ce compte est protégé, pas de quoi s'y connecter.
    twoFactor: { enabled: boolean; remainingCodes: number }
  }
