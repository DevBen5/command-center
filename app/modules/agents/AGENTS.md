...
base. CC-138 a supprimé les seeders (voir le `AGENTS.md` racine, « Le premier compte ») : sur une
...
doctrine déjà écrite dans le `AGENTS.md` racine pour exactement ce dilemme — `BACKUP_MIRROR_DIR`
