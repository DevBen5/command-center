...
name: youtrack-stats
description: |
  Agrège le journal d'usage des skills YouTrack (`.agents/youtrack-usage.log`) et rapporte le
...
`.agents/youtrack-usage.log` (JSONL, un objet par ligne, fichier **non versionné** — voir
...
1. Lire `.agents/youtrack-usage.log`. **Absent ou vide → le dire explicitement** (« aucune
